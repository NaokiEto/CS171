---------------------------------------------------
Please let me know if you are having trouble running my program.

My email address: neto@caltech.edu
----------------------------------------------------
...
To run the 3dwireframe.py, do

python 3dwireframe.py 512 512 < lion1.iv
