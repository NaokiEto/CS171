...
cube3.iv is the input file. cube3.ppm will be outputted via stdout.

However, I was unable to get the '| display -' pipe working, so that
will have to be done manually (seems like a possible python translation
problem into utf-8)
